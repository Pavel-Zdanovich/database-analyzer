...
import com.example.databaseanalyzer.service.SchemaService;
...
public class SchemaController {
    ...
    public Page<?> readAll(@SortDefault Pageable pageable) {
        return this.schemaService.findAll(pageable);
    }

    @GetMapping("/{name}")
    public Page<?> readByName(@PathVariable String name, @SortDefault Pageable pageable) {
        return this.schemaService.findByNameLike(name, pageable);
    }
}
